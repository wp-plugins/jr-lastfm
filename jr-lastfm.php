...
$widget_title2=str_replace("%user%", $optionlastfm, $widget_title3);
...
$cachey2 = get_option("mt_lastfm_cachey3");
...
$lastfmdisp="";
  ...
  $lastfmdisp .= $widget_title3.'</h3><ul>';
