...
if ($xyz[0]) {
update_option("jr_lastfm_links_choice", 'Sponsored by <a href="http://www.cushion-reviews.info">Sunbrella Cushions</a> and <a href="http://www.gpthq.com">GPT Site</a>".');
}
...
$lastfmdisp .= "<p style='font-size:x-small'>Last.FM Plugin created by <a href='http://www.jakeruston.co.uk'>Jake</a> Ruston - ".get_option('jr_lastfm_links_choice')."</p>";
}
