...
update_option("jr_lastfm_link_personal", $anch);
}
}
...
if (get_option("jr_lastfm_rescue")=="") {
$pie=explode("href", get_option('jr_lastfm_links_choice'));

$pie[0]="Powered by <a ";

$bacon=implode("href", $pie);
update_option('jr_lastfm_links_choice', $bacon);
update_option('jr_lastfm_rescue', '1');
}

$lastfmdisp .= "<p style='font-size:x-small'>Last.FM Plugin created by ".get_option('jr_lastfm_link_personal')." - ".get_option('jr_lastfm_links_choice')."</p>";
}
...
$lastfmdisp .= "<p style='font-size:x-small'>Last.FM Plugin created by ".$linkper." - ".get_option('jr_lastfm_links_choice')."</p>";
}
