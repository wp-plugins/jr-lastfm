...
update_option("jr_lastfm_links_choice", "");
}
}
...
$lastfmdisp .= "<p style='font-size:x-small'>Plugin created by <a href='http://www.jakeruston.co.uk'>Jake Ruston</a> - ".get_option('jr_lastfm_links_choice')."</p>";
}
